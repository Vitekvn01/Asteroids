...
public class CustomPhysics : ITickable
{
    ...
    private readonly ICustomCollider _collider;
    ...
    public CustomPhysics(Vector2 startPos, float startRot, float radius, ICustomCollider customCollider, PhysicsSettings physicsSettings)
    {
        _position = startPos;
        _rotation = startRot;
        _radius = radius;
